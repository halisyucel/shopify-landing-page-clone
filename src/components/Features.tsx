        ...
        <section className={'center-col mt-8 mb-28 sm:w-full md:mb-10'}>
            ...
            <div className={'flex lg:flex-col lg:w-full md:px-6'}>
                {[
                    ...
                    <div key={index} className={'w-[300px] mr-6 last:mr-0 xl:w-[240px] xl:mr-4 lg:!w-full lg:mr-0 lg:mb-12'}>
                        <img 
                            src={image}
                            alt={'Shopify Features'}
                            className={'h-[45px]'}
                        />
                        <h2 className={'font-helvatica font-bold text-lg mt-6 lg:mt-4'}>
                            {title}
                        </h2>
