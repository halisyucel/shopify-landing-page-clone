...
const Faqs: React.FC = () => {
	return (
		<section className={'center-col mt-28 mb-28 w-[1025px] lg:w-full lg:px-36 md:!px-14'}>
			<h2 className={'font-helvatica text-shopify-black font-extrabold text-5xl mb-14'}>
				FAQs
			</h2>
			<Accordion title={'What is Shopify and how does it work?'}>
				<p>
					Shopify is a complete commerce platform that lets you start, grow, and manage a
					business.
				</p>
				...
				<p>
					Shopify is completely cloud-based and hosted, which means you don’t have to
					worry about upgrading or maintaining software or web servers. This gives you the
					flexibility to access and run your business from almost anywhere, including your
					mobile device.
				</p>
			</Accordion>
			<Accordion title={'How much does Shopify cost?'}>
				...
				<p>
					After your trial expires, choose a pricing plan that suits the size and stage of
					your business.
				</p>
			</Accordion>
			<Accordion title={'Can I use my own domain name with Shopify?'}>
				...
				<p>
					If you have an existing domain name, you can connect it to Shopify from your
					store’s admin.
				</p>
				<p>
					If you don’t have a domain name yet, you can either buy one through Shopify or a
					third-party provider.
				</p>
			</Accordion>
			<Accordion title={'Do I need to be a designer or developer to use Shopify?'}>
				<p>No, you don’t need to be a designer or developer to use Shopify.</p>
				<p>Signing up for Shopify allows you to:</p>
				<ul>
					<li>
						Customize the look and feel of your store with the online store builder and
						themes.
					</li>
