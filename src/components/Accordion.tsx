    ...
    return (
        <div className={'w-full border-b-[1px] border-gray-300 mt-6'}>
            <div 
                ...
                className={'font-helvatica font-medium text-lg mb-4 flex items-center justify-start cursor-pointer md:text-base md:font-bold'}
            >
                {title}
            ...
            <div 
                ref={panelRef}
                className={`accordion-content w-full font-helvatica font-normal pt-2 overflow-hidden max-h-0`}
