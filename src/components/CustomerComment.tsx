    ...
    return (
        <section className={'center-col mt-16 lg:mt-10 lg:w-full'}>
            <img 
                ...
                className={'h-16'}    
            />
            <h2 className={'mt-8 font-helvatica font-medium text-4xl w-[875px] text-center lg:text-3xl lg:w-full lg:px-4'}>
                "Shopify is better than any other platform we've played with, and we've played with them all."
            </h2>
            <h3 className={'mt-12 mb-20 font-helvatica font-medium text-2xl text-center lg:px-6 md:mb-16'}>
